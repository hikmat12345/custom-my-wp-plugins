...
register_rest_route("v1/", "recent_closed", [
    "methods" => "GET",
    "callback" => "recent_closed_comp",
]);
function recent_closed_comp($request_data)
{
    ...
    $iterator = 1; 
// pagination code end
    $competetion = $wpdb->get_results( "SELECT * FROM wp_Competetion WHERE Date<='" . date("Y/m/d") . "' ORDER BY Id DESC" );
